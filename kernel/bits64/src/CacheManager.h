...
#define CACHE_MAXCACHETABLEINDEX 2 // Max Cache Table
#define CACHE_CLUSTERLINKTABLEAREA 0 // Index of Cluster Link Table Area
#define CACHE_DATAAREA 1 // Invalid Tag(Empty Cache Buffer)
