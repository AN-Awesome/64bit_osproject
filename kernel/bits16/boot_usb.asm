...
DISKREAD:
    ; [AH] 0x02(READ), 0x03(WRITE), 0x04(VERIFY), 0x0C(SEEK), 0x00(RESET), 0x08(READ_DISK_PARAMETERS)
    ...
    INIT_DISK:
        ...
        mov dl, byte [BOOTDRIVE] ; DRIVE NUMBER(0=Floppy)
        int 0x13                ; BIOS SERVICE: Disk I/O Service
        jc HANDLEDISKERROR

    ; USB READ 
    READ_DISK_PARAM:
        mov ah, 0x08            ; BIOS function(AH=0x08(READ_DISK_PARAMETERS))
