...
// Data structure for page entries
typedef struct kPageTableEntryStruct {
    // PML4T, PDPTE: 1bit P, RW, US, PWT, PCD, A, D, PS, G, 3bit Avail, 1bit PAT, 8bit Reserved, 20bit Base Address
    // PDE: 1bit P,RW, US, PWT, PCD, A, D, 1, G, 3bit Avail, 1bit PAT, 8bit Avail, 11bit Base Address
